...
### [A Macro-Finance Model of Credit Spreads](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5313973)
...
<em>with Aditya Khemka</em>

<small><em>Presentations: Bank of England Macro Brown Bag; Asian Finance Association, Taipei; Trans-Atlantic Doctoral Conference, London Business School; Rethinking Economic Theory Conference, Athens</em></small>

<small><em>Winner of Best Doctoral Paper at Saïd Business School, 2024</em></small>
...
### [Multilayer Networks For Text Analysis With Multiple Data Types](https://epjdatascience.springeropen.com/articles/10.1140/epjds/s13688-021-00288-5)

<em>with Yuanming Tao, Lamiae Azizi, Martin Gerlach, Tiago P. Peixoto, and Eduardo G. Altmann</em>

<small><em>Winner of Best Thesis at University of Sydney Mathematics Department</em></small>
...
<small><em>Presentations: LSE Macro PhD Workshop</em></small>
...
This paper develops a continuous-time endowment economy in which demographics shape asset prices by changing the way in which consumption is financed. In a Blanchard-Yaari environment with gradual retirement, the share of consumption financed by dividends relative to labor income becomes the sufficient statistic that links population aging to the price of risk. When individuals face a larger negative duration gap (e.g., because they now expect to spend a longer fraction of their lives in retirement), the economy relies more on dividends to finance consumption. Because dividend income is more exposed to aggregate risk than labor income in the data, this compositional shift raises consumption volatility, increases the volatility of the pricing kernel, and thereby elevates the market price of risk and risk premia. Aging also lowers the risk-free rate through reduced mortality discounting and higher consumption volatility. The mechanism delivers an alternative to rare-disaster narratives for understanding secular movements in risk premia.

### State-Price Targeting: A Macro-Finance Approach for Price-Level Determination

<em>with Theofanis Papamichalis, and Dimitrios P. Tsomocos</em>
